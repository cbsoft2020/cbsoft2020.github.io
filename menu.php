				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu">
						<li class="dropdown-submenu">
							<a class="dropdown-item menu-sbes" href="#" data-toggle="dropdown" data-i18n="menu.trilha_pesquisa">Trilha de Pesquisa</a>
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a class="dropdown-item menu-sbes" href="sbes-pesquisa.php" data-i18n="menu.chamada_trabalhos">Chamada de Trabalhos</a></li>
								<li><a class="dropdown-item menu-sbes" href="artigos.php?evento=sbes-pesquisa" data-i18n="menu.artigos_aceitos">Artigos Aceitos</a></li>
							</ul>
						</li>
						<li class="dropdown-submenu">
						...
						<li class="dropdown-submenu">
							<a class="dropdown-item menu-sbes" href="#" data-toggle="dropdown" data-i18n="menu.trilha_educacao">Trilha de Educação</a>
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a class="dropdown-item menu-sbes" href="sbes-educacao.php" data-i18n="menu.chamada_trabalhos">Chamada de Trabalhos</a></li>
								<li><a class="dropdown-item menu-sbes" style="font-size: 15px" href="artigos.php?evento=sbes-educacao" data-i18n="menu.artigos_aceitos">Artigos Aceitos</a></li>
							</ul>
						</li>
						<li class="dropdown-submenu">
							<a class="dropdown-item menu-sbes" href="#" data-toggle="dropdown" data-i18n="menu.trilha_ferramentas">Trilha de Ferramentas</a>
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a class="dropdown-item menu-sbes" href="sbes-ferramentas.php" data-i18n="menu.chamada_trabalhos">Chamada de Trabalhos</a></li>
								<li><a class="dropdown-item menu-sbes" href="artigos.php?evento=sbes-ferramentas" data-i18n="menu.artigos_aceitos">Artigos Aceitos</a></li>
							</ul>
						</li>
						<li class="dropdown-submenu">
