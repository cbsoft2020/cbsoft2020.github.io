			...
			<div class="col-lg-12 align-self-center">
				<div class="content-block">
					...
					<h4 style="line-height: 50px">
						<span data-i18n="menu.chamada_trabalhos"></span> &ndash; <span data-i18n="sbes.trilha_ideias"></span>
					</h4>
					
					<div class="description-one">
                    	<p data-i18n="sbes.descricao_1d"></p>
					</div>
                    ...
                    <div class="description-one">
						<ul style="margin-left: -20px">
							<li>
								...
								<span data-i18n="sbes.deadlines_ideias.0" style="color: black;"></span>
							</li>
                            <li>
								<span data-i18n="sbes.deadlines_atividades.1" style="color: black;"></span>:
								<span data-i18n="sbes.deadlines_ideias.1" style="color: black;"></span>
							</li>
                            <li>
								<span data-i18n="sbes.deadlines_atividades.2" style="color: black;"></span>:
								<span data-i18n="sbes.deadlines_ideias.2" style="color: black;"></span>
							</li>
							<li>
								<span data-i18n="sbes.deadlines_atividades.3" style="color: black;"></span>:
								<span data-i18n="sbes.deadlines_ideias.3" style="color: black;"></span>
							</li>
							<li>
								<span data-i18n="sbes.deadlines_atividades.4" style="color: black;"></span>:
								<span data-i18n="sbes.deadlines_ideias.4" style="color: black;"></span>
							</li>
						</ul>
					</div>
					<br/>
					...
					<div class="description-one">
						...
						<ul style="margin-left: -20px">
							<?php for ($i=0; $i < count($data->topicos_sbes_ideias_pt); $i++) { ?>
								<li data-i18n="sbes.topicos_sbes_ideias.<?php echo $i; ?>" style="color: black;"></li>
							<?php }	// for ?>
						</ul>
					</div>
					...
					<div class="description-one">
						<p style="margin-bottom: 10px" data-i18n="sbes.descricao_15d"></p>
						<p data-i18n="sbes.descricao_16d"></p>
					</div>
					
					<br/>
					<h5 data-i18n="sbes.secao_doubleblind"></h5>
					<div class="description-one">
						<p style="margin-bottom: 10px" data-i18n="sbes.descricao_17d"></p>
					...
					<div class="description-one">
						...
						<p data-i18n="sbes.comite.9"></p>
						<strong><p style="margin-top: 10px" data-i18n="sbes.pc"></p></strong>
						<?php
							for ($i=0; $i < count($data_pc->pc_sbes_ideias_en); $i++) { ?>
							<p data-i18n="sbes.comite_ideias.<?php echo $i; ?>" style="color: black;"></p>
						<?php }	// for ?>
					</div>
				</div>
			</div>
